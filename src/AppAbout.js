    ...
    <div className="abtRoot">
      <div className="container">
        ...
        <div id="abtCard" style={{ overflow: "visible"}}>
            ...
            designing, and developing interactive and immersive technology. I am currently pursuing a Dual Degree program at <a class="hlink" href="https://www.iiitd.ac.in" target="_blank" rel="noreferrer">IIIT Delhi</a>, Bachelors, and Masters in  <a class="hlink" href="https://www.iiitd.ac.in/academics/btech/csd" target="_blank" rel="noreferrer">Computer Science and Design</a>. At Weave Lab, I worked on my bachelor's thesis under <a class="hlink" href="https://amanparnami.com/" target="_blank" rel="noreferrer"> Dr. Aman Parnami </a>, studying how video streaming platforms keep us hooked. 
