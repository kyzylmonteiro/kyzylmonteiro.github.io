    ...
    return (
      <>
        <instancedMesh ref={mesh} args={[null, null, count]} castShadow receiveShadow>
          ...
          <meshPhongMaterial color="black" shininess={0} />
        </instancedMesh>
      </>
    )
  }
...
function CanvasBG() {
    ...
    <Canvas
      ...
      <pointLight position={[100, 100, 100]} intensity={1} color="white" castShadow />
      <pointLight position={[-100, -100, 100]} intensity={2} color="red" />
      <pointLight position={[100, 100, -100]} intensity={0.25} color="blue" />
      <Swarm count={35} />
